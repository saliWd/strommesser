...
';
printBarGraphCost(dbConn:$dbConn, userid:$userid, timerange:Timerange::Week, param:Param::cost,   goBack:safeIntFromExt('GET','goBackWcost', 2),   isIndexPage:FALSE);
...
';
printBarGraphCost(dbConn:$dbConn, userid:$userid, timerange:Timerange::Month, param:Param::cost,   goBack:safeIntFromExt('GET','goBackMcost', 2),   isIndexPage:FALSE);
...
';
printBarGraphCost(dbConn:$dbConn, userid:$userid, timerange:Timerange::Year, param:Param::cost,   goBack:safeIntFromExt('GET','goBackYcost', 2),   isIndexPage:FALSE);
