...
<div class="text-left mt-4 block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 flex"> 
  ...
  <div><button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button" data-modal-toggle="modal-w">Erklärungen anzeigen</button></div>  
</div>
<div id="modal-w" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 h-modal">
  <div class="relative p-4 w-full h-full">
      <div class="relative bg-white rounded-lg shadow">
          <div class="p-6 text-left">
            ...
            <button data-modal-toggle="modal-w" type="button" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              weniger
            </button>
          </div>
      </div>
...
';
printBarGraph(dbConn:$dbConn, userid:$userid, timerange:EnumTimerange::Week, param:EnumParam::ConsTot, goBack:safeIntFromExt('GET','goBackW', 2), isIndexPage:FALSE);
...
';
printBarGraph(dbConn:$dbConn, userid:$userid, timerange:EnumTimerange::Month, param:EnumParam::ConsTot, goBack:safeIntFromExt('GET','goBackM', 2), isIndexPage:FALSE);
...
';
printBarGraph(dbConn:$dbConn, userid:$userid, timerange:EnumTimerange::Year, param:EnumParam::ConsTot, goBack:safeIntFromExt('GET','goBackY', 2), isIndexPage:FALSE);
...
';
printBarGraph(dbConn:$dbConn, userid:$userid, timerange:EnumTimerange::Year, param:EnumParam::GenTot, goBack:safeIntFromExt('GET','goBackY', 2), isIndexPage:FALSE);
